...
async def restart(client, m: Message):
        ...
        await accha.edit(" 🦚 𝘼𝘽 𝙄𝘿𝙃𝘼𝙍 𝘼𝘼𝙊 𝘽𝙀𝘽 😘 @Nidhianurag , @Nidhi_anurag_bot , @chattinghubucr 𝘼𝙐𝙆𝘼𝙏 𝙈𝘼𝙄 𝙍𝙀𝙃𝙀𝙆𝘼𝙍 𝘽𝘼𝘼𝘼𝙏 𝙆𝙍𝙉𝘼 🐊! 𝘼𝙂𝘼𝙍 𝙆𝙐𝘾𝙃 𝙅𝘼𝙍𝙐𝙍𝙄 𝙃𝘼𝙄 𝙏𝙊𝙃 𝙄𝙎𝙀 @Rudra0_9_1 𝘽𝘼𝘼𝙏 𝙆𝘼𝙍𝙊 🦅")
...
async def ping(client, message: Message):
        ...
        await message.reply_photo(
                             photo=START_IMG,
                             caption=f"ᴀʙᴇ sᴀʟᴇ 😑 !\n**[{BOT_NAME}](t.me/{BOT_USERNAME})** ᴊɪɴᴅᴀ ʜᴜɴ ʙᴇ 🥺 ᴀɴᴅ ɪ ᴡᴏʀᴋ ᴡɪᴛʜ ᴘᴏɴɢ ᴏꜰ \n☞︎︎︎ `{ms}` ms\n\n**ᴍᴀᴅᴇ ᴍᴇ ʙʏ 💝  || [🎀 ᴍᴀᴀʟᴋɪɴ 🎀](https://t.me/Nidhianurag)||**",
